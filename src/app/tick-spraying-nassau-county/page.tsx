...
import { CheckCircle, Phone, ArrowRight, Shield, Bug, Leaf } from "lucide-react";
    ...
    <div className="min-h-screen">
        ...
        <div className="grid gap-12 lg:grid-cols-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-brand-800 text-sm leading-relaxed mb-3">
                    Add mosquito control to your Nassau County tick program for full-season pest protection. Pestify treats both pests in coordinated visits — fewer service calls, complete coverage.
                  </p>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border border-green-100 bg-green-50 p-5">
              ...
              <p className="text-xs text-green-700">Pestify is based in Port Jefferson Station — locally owned, not a national franchise.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-brand-900 py-12">
        <div className="mx-auto max-w-3xl px-4 text-center">
          <h2 className="text-2xl font-extrabold text-white mb-3">Protect Your Yard, Pets &amp; Family in Nassau County</h2>
          <p className="text-brand-200 mb-6">
            Pestify Pest Control provides seasonal tick barrier treatments for Nassau County homeowners. Get a free estimate — no obligation.
          </p>
